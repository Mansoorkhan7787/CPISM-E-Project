$(document).ready(function(){
    $.ajax({
        url : "./E-Project/assets/JSON/decuration.json",
        type : "GET",
    success : function(data){
          ...
          <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="#${values.id}" data-bs-toggle="modal" class=" btn  button btn-custom" >details</a>
  ...
  <span class="mt-3" id="alert"></span>
          ...
          <div class="modal-footer">
            ...
            document.getElementById("decurationlights").innerHTML = card;
